...
var persianStrings = {
  ...
  ed: {
    ...
    moveRight: "به سمت راست اسکرول کنید",
    moveLeft: "به سمت چپ اسکرول کنید",
    deletePage: "حذف صفحه",
    ...
    surveyResults: "نتیجه نظرسنجی: ",
    surveyResultsTable: "به صورت جدولی",
    surveyResultsJson: "به صورت JSON",
    resultsTitle: "عنوان سوال",
    resultsName: "نام سوال",
    resultsValue: "مقدار پاسخ",
    resultsDisplayValue: "مقدار نمایشی",
    modified: "تغییر داده شده",
    saving: "در حال ذخیره سازی",
    saved: "ذخیره شد",
    saveError: "خطا! محتوای نظرسنجی ذخیره نشده است.",
    translationAddLanguage: "یک زبان را برای ترجمه انتخاب کنید",
    ...
    translationExportToSCVButton: "برون بری با CSV",
    translationImportFromSCVButton: "درون ریزی با CSV",
